...
![수식](eq-svg/eq-fc2df94472.png)





![수식](eq-svg/eq-bac6cb0f36.png)



조건부 확률을 알면 텍스트 생성이 가능해진다. 예컨대 "日本 の 首都 は"라는 문맥이 주어졌을 때 

![수식](eq-svg/eq-2af16014dd.png)

, 

![수식](eq-svg/eq-ccd8c911c5.png)

, 

![수식](eq-svg/eq-1afeac2e28.png)

와 같이 단어별 확률을 계산할 수 있으며, 다음 단어 

![수식](eq-svg/eq-83df61fdb8.png)

의 적절한 예측은 

![수식](eq-svg/eq-706e30fc65.png)

로 얻는다. Day 1에서 복습한 "日本の首都は → 東京"도 

![수식](eq-svg/eq-044dcba013.png)
...
![수식](eq-svg/eq-efc381b893.png)

\#(s)

![수식](eq-svg/eq-ceaa19cd04.png)
...
![수식](eq-svg/eq-5b1ba2fe7e.png)

개의 단어만으로 다음 단어를 예측하는 N-gram 언어 모델이 사용되었다. 3-gram 예로 

![수식](eq-svg/eq-2f837ef7e4.png)
...
![수식](eq-svg/eq-b241516fcc.png)

, 

![수식](eq-svg/eq-e854ba382a.png)

, 

![수식](eq-svg/eq-5bbb9dd360.png)

, 

![수식](eq-svg/eq-fe8f9ff956.png)

, 

![수식](eq-svg/eq-17ac1d660a.png)

를 차례로 계산하며, 예측과 정답의 오차(교차 엔트로피)가 작아지도록, 즉 사전학습의 목적 함수로 

![수식](eq-svg/eq-c8dc05a7f3.png)
