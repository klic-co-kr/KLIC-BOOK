...
이런 일은 어떻게 실현되는 걸까요? 단어의 열(문장)을 𝑥₁, 𝑥₂, ⋯, 𝑥_𝐿이라 할 때, 언어 모델은 그 생성 확률 𝑝(𝑥₁, 𝑥₂, ⋯, 𝑥_𝐿)을 할당하는 확률 모델 𝑝로, 자연스러운 문장일수록 높은 확률을 줍니다.
