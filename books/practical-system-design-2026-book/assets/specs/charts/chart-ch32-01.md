...
data_file: data/chart-ch32-01.csv
source_file: assets/src/charts/chart-ch32-01.py
---

# chart-ch32-01 — 차트 제작 명세

## 목적

입력 sequence 길이 증가가 KV cache 점유와 TTFT·unit cost를 어떻게 키우는지 개념적으로 보여준다.
...
하드웨어·모델별 실제 값이 아닌 synthetic trend chart.
