...
data_file: data/chart-ch29-01.csv
source_file: assets/src/charts/chart-ch29-01.py
---

# chart-ch29-01 — 차트 제작 명세

## 목적

backup/restore, pilot light, warm standby, active-active를 상대 RTO와 정상 비용으로 비교한다.
