...
data_file: data/chart-ch02-01.csv
source_file: assets/src/charts/chart-ch02-01.py
---

# chart-ch02-01 — 차트 제작 명세

## 목적

동일한 계산식에서 RPS, 저장량, 대역폭 입력의 낮음·기준·높음 가정이 결과를 어떻게 바꾸는지 비교한다.
...
예시 입력으로 생성하는 synthetic chart. 실제 벤치마크가 아니다.
