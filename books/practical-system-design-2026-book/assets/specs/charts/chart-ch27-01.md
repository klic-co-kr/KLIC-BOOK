...
data_file: data/chart-ch27-01.csv
source_file: assets/src/charts/chart-ch27-01.py
---

# chart-ch27-01 — 차트 제작 명세

## 목적

label dimension을 추가할 때 조합 가능한 time series 수가 곱셈으로 증가하는 모습을 보여준다.
...
Cardinality 원리를 설명하는 synthetic chart.
