...
# fig-ch12-02 — SVG 제작 명세

## 목적

오래된 worker와 새 worker가 같은 자원에 접근할 때 fencing token이 stale write를 막는 모습을 보여준다.
...
- `chubby-paper` — The Chubby Lock Service for Loosely-Coupled Distributed Systems
