...
# fig-ch16-01 — SVG 제작 명세

## 목적

unary·server streaming·client streaming·bidirectional과 REST/gRPC/GraphQL/WebSocket/SSE의 적합도를 비교한다.
...
- `grpc-core` — gRPC Core Concepts
- `graphql-spec` — GraphQL Specification
