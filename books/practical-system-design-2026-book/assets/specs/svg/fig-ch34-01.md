...
# fig-ch34-01 — SVG 제작 명세

## 목적

dataset·offline eval·safety test·release gate·canary·online telemetry·human review·failure feedback loop를 보여준다.
...
- `nist-ai-rmf` — Artificial Intelligence Risk Management Framework (AI RMF 1.0)
- `nist-genai-profile` — Artificial Intelligence Risk Management Framework: Generative Artificial Intelligence Profile
