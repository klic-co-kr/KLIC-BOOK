...
# fig-ch04-01 — SVG 제작 명세

## 목적

사용자 여정에서 SLI·SLO·SLA·error budget 정책으로 내려가는 관계를 보여준다.
...
- `google-sre-slo` — SRE Workbook — Implementing SLOs
- `google-sre-error-budget` — SRE Workbook — Error Budget Policy
