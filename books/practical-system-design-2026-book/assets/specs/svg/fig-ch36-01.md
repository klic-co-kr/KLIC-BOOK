...
# fig-ch36-01 — SVG 제작 명세

## 목적

client·gateway·message service·conversation store·event log·fan-out·sync 경로를 보여준다.
...
- `html-sse` — HTML Living Standard — Server-sent events
