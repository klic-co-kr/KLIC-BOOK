...
# fig-ch32-02 — SVG 제작 명세

## 목적

task risk·quality threshold·latency·cost·capacity에 따라 model과 fallback을 선택하는 decision flow를 보여준다.
...
- `orca-paper` — Orca: A Distributed Serving System for Transformer-Based Generative Models
