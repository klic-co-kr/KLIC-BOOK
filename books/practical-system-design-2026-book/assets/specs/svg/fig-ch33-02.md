...
# fig-ch33-02 — SVG 제작 명세

## 목적

trusted instruction·untrusted retrieval/tool output·memory·credential·sandbox 경계를 보여준다.
...
- `toolformer-paper` — Toolformer: Language Models Can Teach Themselves to Use Tools
