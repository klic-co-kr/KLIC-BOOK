...
# fig-ch07-01 — SVG 제작 명세

## 목적

두 복제본 사이 분할 중 쓰기·읽기 선택과 응답 결과를 시간축으로 보여준다.
...
- `gilbert-lynch-cap` — Brewer's Conjecture and the Feasibility of Consistent, Available, Partition-Tolerant Web Services
- `vogels-eventual` — Eventually Consistent
