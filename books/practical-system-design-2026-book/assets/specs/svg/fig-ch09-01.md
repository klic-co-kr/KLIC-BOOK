...
# fig-ch09-01 — SVG 제작 명세

## 목적

벽시계·단조 시계·Lamport·vector·hybrid logical clock의 목적을 비교한다.
...
- `lamport-time` — Time, Clocks, and the Ordering of Events in a Distributed System
- `rfc9562` — RFC 9562 — Universally Unique IDentifiers (UUIDs)
