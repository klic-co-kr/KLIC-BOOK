...
# fig-ch20-02 — SVG 제작 명세

## 목적

원장 변경이 여러 denormalized view와 secondary index로 전파되고 reconciliation되는 흐름을 보여준다.
...
- `mongodb-data-model` — MongoDB Data Modeling Introduction
