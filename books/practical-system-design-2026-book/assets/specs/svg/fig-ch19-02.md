...
# fig-ch19-02 — SVG 제작 명세

## 목적

단일 DB·read replica·application sharding·distributed SQL의 경계와 비용을 비교한다.
...
- `postgres-indexes` — PostgreSQL Documentation — Indexes
- `postgres-transaction-iso` — PostgreSQL Documentation — Transaction Isolation
- `spanner-paper` — Spanner: Google's Globally-Distributed Database
