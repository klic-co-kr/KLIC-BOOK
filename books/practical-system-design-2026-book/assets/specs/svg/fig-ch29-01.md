...
# fig-ch29-01 — SVG 제작 명세

## 목적

pilot light·warm standby·active-active를 RTO·RPO·비용·복잡도로 비교한다.
...
- `nist-contingency` — NIST SP 800-34 Rev. 1 — Contingency Planning Guide for Federal Information Systems
