...
# fig-ch22-02 — SVG 제작 명세

## 목적

동시 miss가 single-flight·stale fallback·TTL jitter로 원본 한 요청으로 합쳐지는 모습을 보여준다.
...
- `rfc9111` — RFC 9111 — HTTP Caching
- `redis-cache` — Redis Documentation — Client-side caching and cache patterns
- `memcached-docs` — Memcached Documentation
