...
# fig-ch31-01 — SVG 제작 명세

## 목적

source 수집에서 parse·chunk·embedding·index와 query retrieval·rerank·generation까지 전체 파이프라인을 보여준다.
...
- `beir-paper` — BEIR: A Heterogeneous Benchmark for Zero-shot Evaluation of Information Retrieval Models
