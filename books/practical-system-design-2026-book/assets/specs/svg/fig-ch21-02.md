...
# fig-ch21-02 — SVG 제작 명세

## 목적

query가 lexical·vector 후보와 metadata filter·reranker를 거쳐 결과가 되는 흐름을 보여준다.
...
- `s3-consistency` — Amazon S3 Data Consistency Model
- `lucene-docs` — Apache Lucene Documentation
