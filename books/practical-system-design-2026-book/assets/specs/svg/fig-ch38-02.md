...
# fig-ch38-02 — SVG 제작 명세

## 목적

사용자 message가 tenant auth·RAG·model·citation·tool approval·human handoff를 거치는 end-to-end 흐름을 보여준다.
...
- `azure-multitenant` — Azure Architecture Center — Multitenant solutions
