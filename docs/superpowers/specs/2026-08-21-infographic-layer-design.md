# korean-ebook-typst 인포그래픽 레이어 설계 (개정 5판)

- 날짜: 2026-08-21 (초판) / 2026-08-21 (개정 2판 — 적대 검토 3관점 24건 반영) / 2026-08-22 (개정 3판 — 구현 계획 적대 검토 반영 정합화) / 2026-08-22 (개정 4판 — Phase 2 플랜 적대 검토) / 2026-08-22 (개정 5판 — Phase 4 플랜·ladder 단계 상한 정식화)
- 상태: 승인 대기
