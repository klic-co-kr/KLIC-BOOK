...
from infographic.archetypes.base import LayoutError    # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        # 판형 상한 초과(예: practical flow 7단계, cards 7개)도 I1과 같은 한 줄
        # 지적으로 — traceback 크래시는 저작 도구로서 실격(최종 리뷰 Important).
