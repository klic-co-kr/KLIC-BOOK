...
| 핵심 챕터 범위 | ch1-8 본문 + 후기 (전책) — Phase A(ch1/2/8/후기) + Phase B(ch3-7) |
| 통찰 수 | 55개 (엄선 — 원 75후보 중 저가치 20개 제거, 감탄 기준) |
| 카테고리 분포 | 방법(methodology) 29 · 원리(principle) 14 · 연구(research) 4 · 안티패턴 5 · 해법(solution) 3 |
| 부록C 회상율 | **28.3% (34/120)** — 비자명 통찰 위주 추출이라 사례 전수 커버 아님. 회상은 품질 프록시 |
| 게이트 | 사람 승인 2회 (Phase A 31개 + Phase B 24개, 감탄 기준 엄선) |
